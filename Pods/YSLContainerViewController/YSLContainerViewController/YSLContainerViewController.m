...
- (void)viewDidLoad {
    ...
    // meunView
    CGFloat menuViewWidth = [UIScreen mainScreen].bounds.size.width / [self.childControllers count];
    _menuView = [[YSLScrollMenuView alloc]initWithFrame:CGRectMake(0, _topBarHeight, self.view.frame.size.width, kYSLScrollMenuViewHeight) menuViewWidth:menuViewWidth];
